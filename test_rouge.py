...
def test_rouge(cand, ref):
    ...
    try:
        ...
        r = pyrouge.Rouge155("/home/envs/dev/lib/python3.7/site-packages/pyrouge/ROUGE-1.5.5/")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--c', type=str, default='gpt-neo-1.3B_chain_5shot_num_name_topic.txt',
                        help='candidate file')
